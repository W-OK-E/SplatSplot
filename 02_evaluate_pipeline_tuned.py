...
SCENE_GAMMAS = {
    ...
    "flowers": 0.1,
    "roses": 0.1,
    "table": -0.2,     # Broken surface, more forgiving
    "car": 0.2,        # A bit of floaters
    "pipe": 0.3,       # Floaters
    "plant": 0.3,      # Floaters
    "garbage": 0.4,    # Background floaters
    "picnic": 0.4,     # Background
    "pikachu": 0.5,    # Background floaters on couch
    "century": 0.5,    # A lot of background
    "art": 0.6         # Much background
}
...
def main():
    ...
    for scene in SCENES:
        ...
        cmd = [
            ...
            "--ply_in", str(ply_in),
            "--ply_out", str(ply_out),
            "--gamma", str(SCENE_GAMMAS.get(scene, 0.1))
        ]
